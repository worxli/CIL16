...
\section{Evaluation}
First we show how our preprocessed data performs in comparision to non augmented data and how different new features affect the prediction accuracy. The we compare our pipeline to the baseline algorithm. Further we evaluate our postprocessing method, combining the models described above. 
