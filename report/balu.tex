...
The baseline scores \begin{figure}
	...
	\caption{Baseline with scikit}
	\label{fig:baseline}
\end{figure}

\begin{figure}
	\includegraphics[width=\columnwidth]{pictures/baseline1}
	\caption{Original image and manually set labels}
	\label{fig:original_and_truth}
\end{figure}
\begin{figure}
	\includegraphics[width=\columnwidth]{pictures/overlay-post-comb_41}
	\caption{Postprocessed data}
	\label{fig:satlit}
\end{figure}
